...
// Lazy load Three.js background (client-side only, no SSR)
const ThreeBackground = dynamic(() => import("./three-background"), {
  ssr: false,
  loading: () => (
    <div className="absolute inset-0 bg-slate-900 animate-pulse" /> // fallback placeholder
  ),
})
      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-4">
        <div className="max-w-3xl mx-auto backdrop-blur-sm bg-slate-900/30 p-8 rounded-xl">
          ...
          <p className="text-lg md:text-xl text-slate-400 mb-8 max-w-2xl mx-auto">
            ...
            bringing both creativity and technical depth to every project I take
            on.
          </p>
